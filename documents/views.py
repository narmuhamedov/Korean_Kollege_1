...
def documents_license_view(request):
    if request.method == "GET":
        ...
        return render(
            request, template_name="documents/license/license.html", context=context
        )
...
def documents_organization_structure_view(request):
    if request.method == "GET":
        ...
        return render(
            request,
            template_name="documents/structure_org/structure.html",
            context=context,
        )
...
def documents_act_list_view(request):
    if request.method == "GET":
        ...
        return render(
            request,
            template_name="documents/normative_acts/documents_act.html",
            context=context,
        )
...
def documents_act_detail_view(request, id):
    if request.method == "GET":
        ...
        return render(
            request,
            template_name="documents/normative_acts/documents_act_detail.html",
            context=context,
        )
