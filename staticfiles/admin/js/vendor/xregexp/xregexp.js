...
var _default = function _default(XRegExp) {
   ...
   * @ignore
   *
   * Return a reference to the internal Unicode definition structure_org for the given Unicode
   ...
   * @returns {Object} Reference to definition structure_org when the name matches a Unicode Property.
   *
   * @note
