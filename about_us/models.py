...
class About_AUP(models.Model):
    ...
    description = models.TextField(verbose_name="укажите научную степень")
    education = models.TextField(verbose_name="укажите образование", null=True)
    qualification = models.TextField(
        verbose_name="укажите повышение квалификации", null=True
    )
    achievements = models.TextField(
        verbose_name="какие достижения вы достигли", null=True
    )
    sertificate_url = models.URLField(
        verbose_name="укажите ссылку на свой сертификат из DRIVE", null=True
    )
